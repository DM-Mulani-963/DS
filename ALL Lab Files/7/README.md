...
```bash
gcc -o hs hs_leader.c -lpthread -lm
```
...
```bash
./hs <total_nodes> <my_id> <left_id> <right_id> <left_neighbor_port> <right_neighbor_port> <my_left_server_port> <my_right_server_port>
```

Example for 4 nodes in a ring (IDs 1, 2, 3, 4):

```bash
./hs 4 1 4 2 5007 5003 5001 5002
```
...
* **Ring 1 (1-2-3-4) output:** `ring1.png`
* **Ring 2 (1-2-4-3) output:** `ring2.png`
* **Ring 3 (1-3-2-4) output:** `ring3.png`
...
* `hs_leader.c` – Source code
* `Output.pdf` – Sample output for 4-node ring
* `ring1.png` – Execution output for Ring 1 (1-2-3-4)
* `ring2.png` – Execution output for Ring 2 (1-2-4-3)
* `ring3.png` – Execution output for Ring 3 (1-3-2-4)
